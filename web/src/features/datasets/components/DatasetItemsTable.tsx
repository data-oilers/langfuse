...
export function DatasetItemsTable({
  ...
  const columns: LangfuseColumnDef<RowData>[] = [
    ...
    {
      accessorKey: "source",
      header: t("items.source"),
      headerTooltip: {
        description: t("items.sourceTooltip"),
      },
      id: "source",
      size: 90,
      cell: ({ row }) => {
