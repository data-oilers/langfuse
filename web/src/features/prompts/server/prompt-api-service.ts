...
export const listPromptsForApi = async (
  input: z.infer<typeof GetPromptsMetaSchema>,
) => {
  return await getPromptsMeta(input);
};

export const getPromptForApi = async (
  input: z.infer<typeof GetPromptByNameSchema>,
) => {
