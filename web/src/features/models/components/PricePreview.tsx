        ...
        {parsedPrices.success ? (
          <div className="space-y-2">
            <div className="grid grid-cols-[2fr_1fr_1fr_1fr] gap-2 border-b border-border pb-2 text-xs font-medium text-muted-foreground">
              ...
              <span className="text-right">{t("pricing.pricesPerUnit")}</span>
              <span className="text-right">{t("pricing.per1K")}</span>
              <span className="text-right">{t("pricing.per1M")}</span>
            </div>
