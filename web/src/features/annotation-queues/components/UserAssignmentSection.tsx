  ...
  const deleteQueueAssignmentMutation =
    api.annotationQueueAssignments.delete.useMutation({
      onSuccess: () => {
        ...
        showSuccessToast({
          title: t("annotationQueues.removedAssignmentTitle"),
          description: t("annotationQueues.removedAssignmentDescription"),
        });
      },
    });
  ...
  return (
    <div className="space-y-4" ref={containerRef}>
      ...
      <MultiSelectCombobox
        ...
        placeholder={t("annotationQueues.searchUsersPlaceholder")}
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-3">
                <p className="truncate text-xs font-medium">
                  {user.name || t("annotationQueues.unnamedUser")}
                </p>
                ...
                <div className="flex items-center gap-3 px-3 py-2 text-muted-foreground">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs italic">
                      {t("annotationQueues.moreAssignedUsers", {
                        count:
                          queueAssignmentsQuery.data.totalCount -
                          queueAssignmentsQuery.data.assignments.length,
                      })}
